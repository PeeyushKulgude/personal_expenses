...
class AppColors {
  ...
  static Color dayHeaderContainerTextColorDark =
      const Color.fromRGBO(89, 181, 185, 100);
  static Color dayHeaderContainerTextColorLight =
      const Color.fromRGBO(0, 0, 0, 0.7);
  static Color dayHeaderContainerBackgroundColorDark =
      const Color.fromRGBO(48, 48, 48, 100);
  static Color dayHeaderContainerBackgroundColorLight =
      const Color.fromRGBO(114, 172, 175, 1);
  static Color dayHeaderContainerBorderColorDark =
      const Color.fromRGBO(71, 71, 71, 100);
  static Color dayHeaderContainerBorderColorLight =
      const Color.fromRGBO(125, 176, 178, 1);
  static Color dayHeaderDateTextColorDark =
      const Color.fromRGBO(72, 145, 148, 0.7);
  ...
  static Color chartBarBorderColorLight =
      const Color.fromRGBO(250, 250, 250, 1);
  static Color chartBarBackgroundColorDark =
      const Color.fromRGBO(61, 61, 61, 100);
  static Color chartBarBackgroundColorLight =
      const Color.fromRGBO(227, 227, 227, 1);

  static Color newTransactionIconColorDark =
      const Color.fromRGBO(255, 255, 255, 1);
  static Color newTransactionIconColorLight =
      const Color.fromARGB(255, 126, 126, 126);

  static Color newTransactionTextFieldColorDark =
